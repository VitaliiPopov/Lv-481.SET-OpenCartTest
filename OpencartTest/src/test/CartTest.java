...
public class CartTest extends TestRunner {
    ...
    public void addProductWithoutOptionsToCartAlertCheck() throws Exception {
        ...
        //
        SearchPage addToCartIPhoneSearchPage = (SearchPage) ipSearchPage.afterClickProductComponentAddToCartButtonByName("iPhone");
        softAssert.assertTrue(addToCartIPhoneSearchPage.getAddProductToCartAlertComponent().getAlertMessageText().contains("Success: You have added iPhone to your shopping cart!"));
        //
    ...
    public void addProductWithOptionsToCartAlertCheck() throws Exception {
        ...
        //Assert TODO -> SearchCriteriaComponent
        //
        ProductPage productPage = (ProductPage) cinemaSearchPage.afterClickProductComponentAddToCartButtonByName("Apple Cinema 30");
        ...
        softAssert.assertTrue(productPageAfterAddToCart.getAddProductToCartAlertComponent().getAlertMessageText().contains("Success: You have added Apple Cinema 30 to your shopping cart!"));
        //
    ...
    public void addTooManyProduct() throws Exception {
        ...
        softAssert.assertTrue(productPageAfterAddToCart.getAddProductToCartAlertComponent().getAlertMessageText().contains("Unsuccess:"));
        //
    ...
    public void checkUncorrectFunctionOfRefreshButtonInCart() throws Exception {
        ...
        productPage.getAvailableOptionsComponent().setOptionsForAppleCinema("Radio", "Small",
                ...
                "Select", "Red (+$4.00)");
        ProductPage productPageAfterAddToCart = productPage.goToProductPageAfterAddToCart(3);
        Assert.assertTrue(productPageAfterAddToCart.getAddProductToCartAlertComponent().getAlertMessageText().contains("Success: You have added Apple Cinema 30 to your shopping cart!"));
        //
        //TODO
        Thread.sleep(1000);
        CartPage cartPage = productPageAfterAddToCart.goToShoppingCartFromAlert();
